...
In [this project](Project%2003%20—%20Comparing%20Naive%20Bayes%20Models%20with%20Neural%20Network%20Models), we compare the models used in [project 01](Project%2001%20—%20Understanding%20&%20Explaining%20a%20Machine%20Learning%20Algorithm) (Naive Bayes Classifiers—Multinomial, Bernoulli, and Gaussian) with various neural network algorithms to see whether neural networks can outperform Naive Bayes classifiers in spam detection using the SMS Spam Collection Dataset.
...
* **README**: A detailed README.md file dedicated only for this project can be found [here](Project%2003%20—%20Comparing%20Naive%20Bayes%20Models%20with%20Neural%20Network%20Models/README.md).

* **Notebook:** The Jupyter Notebook can be found [here](Project%2003%20—%20Comparing%20Naive%20Bayes%20Models%20with%20Neural%20Network%20Models/Neural%20Network.ipynb).
